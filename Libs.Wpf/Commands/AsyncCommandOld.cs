...
internal class AsyncCommandOld<TCommandParameter, TExecuteResult> : ViewModelBase, ICancellableCommand
{
    /// <summary>
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="AsyncCommandOld{TCommandParameter,TExecuteResult}" /> class.
    /// </summary>
    ...
    private void Setup()
    {
        ...
        {
            this.CancelCommand = new AsyncCommandOld<object, object>(
